...
void drawScreen() {
  ...
  switch (
    ...
    case SCREEN_PIN_DETAIL:
      drawPinDetail();
      break;
    case SCREEN_PWM_INPUT:
      drawPWMInput();
      break;
  }
}
  ...
  for (
    ...
    if (
      ...
      // ======================================================
        ...
        currentScreen == SCREEN_PWM_INPUT
      ) {
      ...
      // ======================================================
        ...
        currentScreen == SCREEN_PIN_DETAIL
      ) {
        ...
        if (label == "< PINS") {
        ...
        else if (label == "D-READ") {

          String response =
            sendCommand(
              "pins",
              "{\"action\":\"digital_read\",\"pin\":" +
              String(selectedPin) +
              "}"
            );
        ...
        else if (label == "D-HIGH") {

          sendCommand(
            "pins",
            "{\"action\":\"digital_write\",\"pin\":" +
            String(selectedPin) +
            ",\"value\":true}"
          );
        }
        ...
        else if (label == "A-READ") {

          String response =
            sendCommand(
              "pins",
              "{\"action\":\"analog_read\",\"pin\":" +
              String(selectedPin) +
              "}"
            );
          ...
          label.startsWith("PWM ")
        ) {

          int value =
            label.substring(4).toInt();

...
The Dreamdeck is an AI cyberdeck that features plenty of features such as a chat with an offline, local AI, a morse code translator and emitter, dht11 temperature and humidity control, buzzer piano, built in gpio control command terminal and other utility features.
